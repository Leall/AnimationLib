...
package com.example.animationlib.like;
...
/**
 * 点赞布局
 * create by xuchen at  2017/4/24 0024 13:50
 */

public abstract class PeriscopeLayout extends RelativeLayout {
...
//    }
    ...
    private void init() {
        ...
        ArrayList<Integer> list = initDrawable();
        drawables = new Drawable[list.size()];
        for (int i = 0; i < list.size(); i++) {
            drawables[i] = getResources().getDrawable(list.get(i));
        }
    ...
    public abstract ArrayList<Integer> initDrawable();
